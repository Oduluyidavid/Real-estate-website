      ...
      rounded-xl grid lg:grid-cols-2 grid-cols-2 justify-center items-center lg:px-36 px-6 py-20 gap-10`}>
        <div data-aos='zoom-in' className='bg-white dark:bg-black p-10 flex flex-col 
         justify-center items-start gap-4 rounded-xl'>
          ...
          <button className='bg-red-600 w-full text-md px-8 py-3 text-white font-semibold rounded-xl hover:bg-black dark:hover:bg-red-700 cursor-pointer'>SUBMIT</button>
        </div>
        <div className='flex flex-col justify-center items-start gap-8 lg:p-20 py-6'>
          ...
          <h1 data-aos='zoom-in' data-aos-delay='400' className='text-black text-[40px] font-semibold leading-10 dark:text-white'>
            There are many alternatives to the standard “Contact Us”. Here are some of them: Talk to Us. Get in Touch.</h1>
            <button className='bg-red-600 w-full text-md px-8 py-3 text-white font-semibold rounded-xl hover:bg-black dark:hover:bg-red-700 cursor-pointer'>SUBMIT</button>
        </div>
      </section>
