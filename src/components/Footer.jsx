...
const Footer = () => {
  ...
  return (
    <>
      <footer
        className={`${darkMode ? "dark bg-black" : "light bg-gray-800"} w-full m-auto lg:px-20 px-10 py-20 lg:grid-cols-3 grid-cols-1 justify-center items-start lg:gap-20 gap-10`}>
          <div className="lg:flex flex-col justify-center items-start gap-5">
            <h1 className="text-white text-2xl font-semibold">About Us</h1>
            <p className="text-slate-200 text-justify">Good real estate investment can be a valuable addition to your portfolio. There are various ways to invest in real estate, each with its unique benefits and risks.</p>
            ...
            <h1 className="text-white mt-8 fixed bottom-0 items-center">Copyright 2024 Real Estate,All Rights Reserved</h1>
          </div>
